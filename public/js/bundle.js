...
/* eslint-disable */
var _default = function _default(type, msg) {
  hideAlert();
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              //-> CAN NOT work with 127.0.0.1:3000
              data: {
                email: email,
                password: password
              }
...
var _default = function _default(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHVhbmxlMjA3IiwiYSI6ImNrNzVvNG96MzBoZmIzbXNiMHhmb2J6OGsifQ.hDb2Uf0IHIHaeFbtDqxIYQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/tuanle207/ck75uurk009fg1imo8zapr40x',
    scrollZoom: false // center: [-118.130196, 34.176979],
    // zoom: 10,
    // interactive: false
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.default)('success', 'Update information successfully!');
...
var updateUserInfoForm = document.querySelector('.form.form-user-data'); // MAP BOX
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password'); //console.log(email.value, password.value);
